    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/85 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="relative max-w-md w-full mx-4 p-8 rounded-3xl border border-red-500/20 bg-slate-950/90 text-center shadow-[0_0_50px_rgba(239,68,68,0.15)] animate-in zoom-in-95 duration-200">
        ...
        <div className="relative mx-auto mb-6 w-20 h-20 flex items-center justify-center">
          ...
          <div
            className="absolute -right-1 top-4 w-2 h-2 rounded-full bg-red-500/60 animate-bounce"
            style={{ animationDuration: '3s' }}
          />
          <div
            className="absolute -right-3 top-7 w-3 h-3 rounded-full bg-red-500/80 animate-bounce"
            style={{ animationDuration: '4s' }}
          />
          <div
            className="absolute -right-2 top-11 w-1.5 h-1.5 rounded-full bg-red-500/40 animate-bounce"
        ...
        <p className="text-sm text-slate-400 leading-relaxed mb-8 px-4">{message}</p>
