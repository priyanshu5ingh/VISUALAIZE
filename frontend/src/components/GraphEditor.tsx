...
const formatGraphStructure = (data: GraphData) =>
  JSON.stringify({ title: data.title, nodes: data.nodes, edges: data.edges }, null, 2);

const formatExecutionTrace = (data: GraphData) =>
                ...
                {activeTab === 'CODE' && (
                  <div className="h-full flex flex-col">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <CopyButton
                        text={graphData.code_snippet}
                        label="Copy code"
                        showLabel
                        className="bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 border-emerald-500/20 hover:text-emerald-300 px-3 py-1.5 min-w-0 min-h-0"
                      />
                    </div>
