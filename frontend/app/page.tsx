        ...
        {appState === 'LANDING' && (
          ...
          >
            ...
            >
              ...
              <span className="text-xs font-semibold tracking-wider uppercase group-hover:text-yellow-400 transition-colors">Instant</span>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.15, y: -4 }}
              transition={{ type: 'spring', stiffness: 300, damping: 15 }}
            ...
            >
              ...
              <span className="text-xs font-semibold tracking-wider uppercase group-hover:text-indigo-400 transition-colors">Neural</span>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.15, y: -4 }}
              transition={{ type: 'spring', stiffness: 300, damping: 15 }}
            ...
            >
              ...
              <span className="text-xs font-semibold tracking-wider uppercase group-hover:text-fuchsia-400 transition-colors">Export</span>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
